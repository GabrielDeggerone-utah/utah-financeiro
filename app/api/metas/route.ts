...
export async function GET(req: NextRequest) {
  ...
  let query = admin.from('metas').select('*')
...
export async function POST(req: NextRequest) {
  ...
  const {
    assessor_id, mes,
    meta_receita, meta_captacao_net,
    meta_contas_abertas, meta_pontos,
  } = body
