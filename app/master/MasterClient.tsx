...
type Receita = {
  ...
  assessor_id: string; profiles: { nome: string } | null
...
type Props = { nome: string; receitas: Receita[]; backups: Backup[] }
...
export default function MasterClient({ nome, receitas, backups }: Props) {
